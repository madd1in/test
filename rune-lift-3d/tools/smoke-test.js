...
const checks = [
  ...
  [html.includes("Blockschiebe-Raetsel"), "block-push puzzle is surfaced in start copy"],
  ...
  [js.includes("addPushBlock") && js.includes("addBlockTarget"), "block-push puzzle pieces are wired"],
  [js.includes("updatePushBlocks"), "push block movement is wired"],
  [js.includes("blockGate"), "block gate progression is wired"],
  [js.includes("Blockaltar offen"), "block puzzle completion feedback is present"],
  [js.includes("Schiebebloecke auf Zielplatten"), "block puzzle objective text is present"],
