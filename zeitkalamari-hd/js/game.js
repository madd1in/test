...
const ROOMS = {
  lab: {
    ...
    layers: [
      {
        id: "portalGlow",
        src: "assets/imagen/calibrated/frames/lab-portal-calibrated-sheet.png",
      ...
      {
        id: "vacuumTubes",
        src: "assets/imagen/calibrated/frames/lab-tubes-calibrated-sheet.png",
        className: "tube-glow",
        frames: 6,
        duration: 0.9,
        x: 20.0,
      ...
      {
        id: "professor",
        src: "assets/imagen/calibrated/frames/professor-calibrated-sheet.png",
      ...
      {
        id: "tankSquid",
        src: "assets/imagen/calibrated/frames/lab-tank-calibrated-sheet.png",
  ...
  past: {
    ...
    layers: [
      {
        id: "chef",
        src: "assets/imagen/calibrated/frames/chef-calibrated-sheet.png",
      ...
      {
        id: "yeastGel",
        src: "assets/imagen/calibrated/frames/yeast-calibrated-sheet.png",
        className: "gel-layer",
        frames: 6,
        duration: 0.95,
        x: 39.5,
  ...
  future: {
    ...
    layers: [
      {
        id: "guard",
        src: "assets/imagen/calibrated/frames/guard-calibrated-sheet.png",
      ...
      {
        id: "caseFork",
        src: "assets/imagen/calibrated/frames/case-calibrated-sheet.png",
...
function render() {
  ...
  els.sceneImage.src = ASSET(room.background);
  els.sceneImage.alt = room.title;
