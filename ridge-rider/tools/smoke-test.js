...
const required = [
  ...
  "assets/foreground/front-tiles-imagen.png",
  "assets/foreground/trail-props-imagen.png",
...
for (const token of ["<canvas", "./js/game.js", "front-tiles-imagen.png", "ridge-bgm.wav", "rider-imagen.png"]) {
