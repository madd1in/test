...
- Pfeil runter oder S: Bonusroehre betreten; auf Touch auch per Run-Button oder Abwaerts-Wisch
- P oder Escape: Pause
- R: Neustart
...
- Neues Pipeworks-/Boss-Imagen-Atlasblatt `assets/imagen-hd/gfx/hd-underground-boss-atlas-imagen.png` fuer Untergrundtiles, Bonusroehren, Mega-Raketen, Kanonenroehren, Gleiterkostuem, Flugschiff und Shell-Boss
- Wiederholbarer Imagen-Hintergrund `assets/imagen-hd/gfx/hd-repeatable-background-imagen.png` mit Parallax-Layern
- Vier Level mit klareren Themes: Meadow, Sky-Palace, Cave-Rush und Pipeworks-Airship
...
- Bonusroehren warpen in einen Untergrund-Abschnitt; Mega-Kanonenroehren schiessen den Helden schraeg heraus
- Pipeworks-Airship bringt Mega-Raketen, Gleiteranzug, Flugschiff-Plattformen und einen Shell-Boss, der vor der Zielfahne besiegt werden muss
...
Die aktive Basisgrafik nutzt `assets/imagen-hd/gfx/hd-mascot-platformer-atlas.png` mit frameweiser Freistellung. Kaefer kommen aus `assets/imagen-hd/gfx/hd-clean-gameplay-atlas.png`. Basis-Tiles kommen aus `assets/imagen-hd/gfx/hd-playfield-tileset-imagen.png`; die saubereren Piranhas, Theme-Tiles und Sky-Blue-Beetles kommen aus `assets/imagen-hd/gfx/hd-theme-hazard-atlas-imagen.png`. Pipeworks-Mechaniken und Boss-Assets kommen aus `assets/imagen-hd/gfx/hd-underground-boss-atlas-imagen.png`.
